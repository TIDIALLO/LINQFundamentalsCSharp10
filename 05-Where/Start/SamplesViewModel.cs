namespace LINQSamples
{
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<Product> WhereMethod()
    {
      ...
      list = products.Where(prod => prod.Name.StartsWith("M")).ToList();
    ...
    public List<Product> WhereTwoFieldsMethod()
    {
      ...
      // Write Method Syntax Here
      list = products.Where(prod => prod.Name.StartsWith("s") && prod.StandardCost > 200).ToList();
